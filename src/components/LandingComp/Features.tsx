...
export function Features() {
  ...
  return (
    ...
    <div className="container px-4 md:px-6 max-w-7xl"> {/* Adjusted max-w */}
      ...
      <div className="mx-auto grid max-w-6xl items-start grid-cols-2 gap-2 min-[600px]:grid-cols-2 pt-12 lg:grid-cols-2"> {/* Same max-w */}
        {features.map((feature, index) => (
          <Card
            key={index}
            className="flex flex-col items-center justify-center space-y-2 p-3 min-h-52 shadow-none"
          >
