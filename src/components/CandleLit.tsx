...
const BrightCandleView: React.FC<BrightCandleViewProps> = ({ fftData = [] }) => {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center p-2">
            {/* Reduced width Candle Container */}
          ...
          before:absolute before:inset-0 before:bg-white/10 before:opacity-50 before:rounded-b-xl before:rounded-t-md
          after:absolute after:bottom-0 after:left-0 after:right-0 after:h-2 after:bg-gradient-to-b after:from-transparent after:to-gray-300/30"
                >
                    <div className="absolute inset-0 overflow-hidden rounded-b-xl rounded-t-md">
                ...
                <svg
                    ...
                    viewBox="0 0 200 300"
                    className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full h-48 z-10"
                >
                    <defs>
                    ...
                    {/* Outer Flame Layer - soft and translucent */}
                    <path
                        d={generateFlamePath()}
                    ...
                    {/* Inner Flame Layer - bright, vivid core */}
                    <path
                        d={generateFlamePath()}
                ...
                <div
                    className="absolute top-12 left-1/2 transform -translate-x-1/2 w-0.5 h-8 bg-gray-400 dark:bg-gray-300 rounded-full z-20
          shadow-lg animate-wickFlicker"
                ></div>
